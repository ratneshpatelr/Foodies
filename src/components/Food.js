...
const Food = () => {
    ...
    return (
        <div className='max-w-[1240px] m-auto px-4 py-12'>
            ...
            {/* diplay food */}
            <AnimatePresence>
                <div className='grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4 bg-slate-400 p-10 border-l border-slate-400 rounded-sm'>
                    {foods.map((item, index) => (
                        <motion.div
                            ...
                            key={item.id}
                            className="border shadow-lg rounded-lg hover:scale-105 duration-500 cursor-pointer bg-slate-300">
